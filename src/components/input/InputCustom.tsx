...
export default function InputCustom(props:InputProps) {
    return (
            <Input {...props} variant={'bordered'}   classNames={{
                input:" text-text placeholder:text-text-dark ",
                inputWrapper:"rounded-md pr-0 group-data-[focus=true]:border-border duration-300 ease-in-out border-border-dark data-[hover=true]:border-border ",
